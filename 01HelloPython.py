...
print("한줄에 "); print("여러줄 쓰려면"); print("세미클론이 필요함")


print("==========================")
print("여러 변수 선언")
print("==========================")
# 좌측항은 변수, 우측항은 할당할 값으로 구분하여 선언 및 초기화 한다.
...
print("x / y", x / y) # 나누기 항상 float형 결과 반환
print("x // y", x // y) # 나누기 소수부분을 제거하므로 항상 int형의 결과를 반환
print("x * y", x * y)
print("x ** y", x ** y) # 거듭제곱 2의 4승을 계산
...
print(engStr[:3]) # 0~3까지의 범위에서 3 앞까지 가져온다.(실제 0~2 까지임) Hel
...
# 인덱스를 대신 변수를 사용하는 방법. 단 default값을 지정할때는 "변수명=값" 으로 사용한다.
menu1 = "치킨"
menu2 = "맥주"
